...
//     } else {
//       // if nothing found, just ignore silently
...
//                           {/* scheme pills from sources (if any) */}
...
//                                   type="button"
//                                   onClick={() =>
//                                     openSchemeByName(s.name_hi || s.name_en)
//                                   }
...
//                           {/* minimal scheme cards from msg.cards (no Apply/Read) */}
//                           {msg.cards?.length > 0 && (
...
//                                   type="button"
//                                   onClick={() =>
//                                     openSchemeByName(c.title_hi || c.title)
//                                   }
...
<<<<<<< HEAD
  // ---------- Load chats from localStorage when storageKey changes ----------
=======
  // 👁️ show/hide sidebar
  const [showSidebar, setShowSidebar] = useState(true);
