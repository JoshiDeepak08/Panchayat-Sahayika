...
// // }
// // src/screens/FinderScreen.jsx  (or SelectScheme.jsx)
...
//   // --- Helper to render details card for selected scheme ---
//   const renderDetails = (scheme) => {
//     if (!scheme) {
//       return (
//         <div className="bg-white rounded-3xl shadow-sm p-5 text-sm text-gray-500">
//           किसी योजना को बाएँ से चुनें, यहाँ उसकी पूरी जानकारी दिखेगी।
//         </div>
//       );
//     }
...
//     return (
//       <div className="bg-white rounded-3xl shadow-md p-6 text-sm space-y-4">
//         {/* Title */}
//         <div>
...
//         {/* Hindi + English description if available */}
...
//         {/* Fallback: show remaining JSON fields in kv grid */}
...
//         Total: {SCHEMES.length} • Schemes: {typeCounts.scheme} • Programmes:{" "}
//         {typeCounts.programme}
//       </div>
...
//           {serviceType && (
//             <Chip>
//               Type: {serviceType === "scheme" ? "Schemes" : "Programmes"}
//             </Chip>
//           )}
...
//           <div className="hidden md:grid md:grid-cols-[minmax(0,2fr)_minmax(0,1.3fr)] gap-4">
//             {/* LEFT: schemes list (clickable, no Apply/Read More) */}
...
//                 const shortDesc =
//                   s.description_hi || s.description_en || "—";

//                 const isActive = selectedScheme === s;
...
//                     className={[
//                       "w-full text-left bg-white rounded-3xl shadow-sm border px-4 py-3 transition",
//                       isActive
//                         ? "border-emerald-500 shadow-md"
//                         : "border-[#F4E3C3] hover:shadow-md",
//                     ].join(" ")}
//                   >
...
//                           <span>Verified by Panchayat Portal</span>
//                         </div>
//                       </div>
//                     </div>
//                   </button>
...
//             <div>{renderDetails(selectedScheme)}</div>
//           </div>

//           {/* Mobile: list first, details below */}
      ...
      <div className="h-full w-full overflow-y-auto px-6 py-4 space-y-4">
        ...
        {filtered.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {filtered.map((s, i) => {
              ...
              const titleEn =
                s.name_en || s.scheme_name_en || s.title_en || "";
              const shortDesc = s.description_hi || s.description_en || "—";
        ...
        {selectedScheme && (
          <div
            ...
            onClick={() => setSelectedScheme(null)}
          >
            {/* stop click from closing when clicking inside card */}
